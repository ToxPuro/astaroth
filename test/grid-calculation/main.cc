...
main(void)
{
    ...
    fprintf(stderr,"Domain coordinates: (%d,%d,%d)\n"
		    ,info[AC_domain_coordinates].x
		    ,info[AC_domain_coordinates].y
		    ,info[AC_domain_coordinates].z
	   );
    fprintf(stderr,"Offset: (%d,%d,%d)\n"
		    ,info[AC_multigpu_offset].x
		    ,info[AC_multigpu_offset].y
		    ,info[AC_multigpu_offset].z
	   );
    ...
    **/
    ...
    fprintf(stderr,"First grid point: %.14e\n",info[AC_first_gridpoint].x);
    fprintf(stderr,"Len: %.14e\n",info[AC_len].x);
    fprintf(stderr,"First + Len: %.14e\n",info[AC_len].x + info[AC_first_gridpoint].x);
    ...
    fprintf(stderr,"%d: Last point theta: %.14e\n",pid,info[AC_theta][info[AC_last_active_local_point].y]);
