...
/*THIS FILE IS NOT THE ORIGINAL tinyexpr.c AS THE STATUS OF IT WAS WHEN COPIED FROM GITHUB FROM 3/5/2024
 * I have added explicit conversions to suppress compiler warnings
 *
 */
...
static double ncr(double n, double r) {
    if (n < 0.0 || r < 0.0 || n < r) return (double) NAN;
    if (n > UINT_MAX || r > UINT_MAX) return (double) INFINITY;
