...
# Strong scaling
# $SRUN ./tfm-mpi --config $CONFIG --global-nn-override 128,128,128 --job-id $SLURM_JOB_ID

# Weak scaling
$SRUN ./tfm-mpi --config $CONFIG --global-nn-override 1024,1024,1024 --job-id $SLURM_JOB_ID  --benchmark 1
