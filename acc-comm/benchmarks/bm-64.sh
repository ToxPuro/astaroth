...
# Weak scaling
$SRUN ./tfm-mpi --config /users/pekkila/astaroth/samples/tfm/mhd/mhd.ini --global-nn-override 512,512,512 --job-id $SLURM_JOB_ID  --benchmark 1 # More than 5 min, note: need also disable bfield
