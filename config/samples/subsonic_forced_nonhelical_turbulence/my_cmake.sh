...
case $HOSTNAME in 
  ( gp8.tiara.sinica.edu.tw | gp9.tiara.sinica.edu.tw | gp10.tiara.sinica.edu.tw | gp11.tiara.sinica.edu.tw  | gp10 ) 
     cmake -DDOUBLE_PRECISION=ON -DMPI_ENABLED=ON -DBUILD_SAMPLES=OFF  -DUSE_HIP=OFF -DUSE_CUDA_AWARE_MPI=OFF -DDSL_MODULE_DIR=../../../acc-runtime/samples/mhd_modular/ -DCMAKE_CXX_COMPILER=/software/opt/gcc/9.1.0/bin/gcc -DCMAKE_C_COMPILER=/software/opt/gcc/9.1.0/bin/gcc ../../.. 
     ;;
  (*) 
