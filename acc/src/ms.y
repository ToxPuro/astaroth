...
kernel: KERNEL         { $$ = astnode_create(NODE_UNKNOWN, NULL, NULL); astnode_set_buffer("__global__ void", $$); $$->token = 255 + yytoken; };
...
function_definition: declaration function_body {
                        ...
                        if (is_kernel) {
                            ...
                            astnode_set_prefix("{\n"
                                ...
                                "        multigpu_offset.x + vertexIdx.x,\n"
                                "        multigpu_offset.y + vertexIdx.y,\n"
                                "        multigpu_offset.z + vertexIdx.z,\n"
                                "    };\n"
