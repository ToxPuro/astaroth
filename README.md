...
> **Optional:** Documentation can be generated by running `doxygen` in the base directory. Generated documentation can be found in `doc/doxygen`. Documentation automatically generated after every commit can be found also from https://toxpuro.github.io/astaroth.
