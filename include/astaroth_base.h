...
typedef enum AcBoundary {
    ...
    BOUNDARY_X_TOP_Y_BOT_Z_BOT = BOUNDARY_X_BOT | BOUNDARY_Y_BOT | BOUNDARY_Z_BOT,
    BOUNDARY_X_TOP_Y_BOT_Z_TOP = BOUNDARY_X_BOT | BOUNDARY_Y_BOT | BOUNDARY_Z_TOP,
    BOUNDARY_X_TOP_Y_TOP_Z_BOT = BOUNDARY_X_BOT | BOUNDARY_Y_TOP | BOUNDARY_Z_BOT,
    BOUNDARY_X_TOP_Y_TOP_Z_TOP = BOUNDARY_X_BOT | BOUNDARY_Y_TOP | BOUNDARY_Z_TOP,
