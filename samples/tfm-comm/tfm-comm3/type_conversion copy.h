...
#define as_uint64_t_array(count, a, b)                                                             \
    _Generic((a[0]), int64_t: int64_t_as_uint64_t_array, int: int_as_uint64_t_array)(count, a, b)
#define as_int64_t_array(count, a, b)                                                              \
    _Generic((a[0]), uint64_t: uint64_t_as_int64_t_array, int: int_as_int64_t_array)(count, a, b)
#define as_int_array(count, a, b)                                                                  \
    _Generic((a[0]), uint64_t: uint64_t_as_int_array, int64_t: int64_t_as_int_array)(count, a, b)
