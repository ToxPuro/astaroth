...
bool errchk_check_ok(const char* function, const char* file, const long line,
                     const char* expression, const char* description);

#define CHECK_OK(expression, description)                                                          \
    errchk_check_ok(__func__, __FILE__, __LINE__, #expression, (description))
