...
void dynarr_remove(const uint64_t index, DynamicArray* arr);

void dynarr_remove_multiple(const uint64_t index, const size_t count, DynamicArray* arr);

void* dynarr_get(const uint64_t index, const DynamicArray arr);
