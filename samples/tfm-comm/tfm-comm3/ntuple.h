...
Ntuple make_ntuple_ones(const size_t nelems);
Ntuple make_ntuple_with_elems(const size_t nelems, const uint64_t* elems);
Ntuple make_ntuple_from_mpi(const int nelems, const int* elems);
...
Ntuple ntuple_mul(const Ntuple a, const Ntuple b);
Ntuple ntuple_scal_mul(const uint64_t a, const Ntuple b);
