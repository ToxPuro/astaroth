...
template <typename T>
void
pack(const Shape mm, const Shape block_shape, const Index block_offset, PackInputs<T> inputs,
     double* output)
{
...
template <typename T>
void
unpack(const double* input, const Shape mm, const Shape block_shape, const Index block_offset,
