...
#plt.legend()
#plt.show()
plt.savefig(f'{args.output_dir}/aa-rms-max')
plt.close()
...
plt.legend()
# plt.show()
plt.savefig(f'{args.output_dir}/alp-eta')
plt.close()
...
plt.legend()
# plt.show()
plt.savefig(f'{args.output_dir}/alp-div-alp0')
plt.close()
#
...
plt.legend()
# plt.show()
plt.savefig(f'{args.output_dir}/eta-div-eta0')
plt.close()
