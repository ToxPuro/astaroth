...
# TFM scale and Bampl are hardcoded!
kz=1.0
Bampl=1.0
...
avhel=np.sum(helavg,axis=0)/nzz
print("avurms=",avurms)
print("Helicity",avhel)

ttt=max(tt)*np.arange(nzz)/(1.0*nzz-1.0)

#plt.yscale('log')
#plt.plot(tt,dfaa['rms'],label='AA rms')
#plt.plot(tt,dfaa['max'],label='AA max')
#plt.legend()
#plt.show()
plt.plot(dfaa['rms'])
plt.plot(dfaa['max'])
...
plt.plot(z,alp11z,label="alp11 over z")
plt.plot(z,alp21z,label="alp21 over z")
plt.plot(z,alp12z,label="alp12 over z")
plt.plot(z,alp22z,label="alp22 over z")

plt.legend()
plt.show()
#
plt.plot(z,eta11z,label="eta11 over z")
plt.plot(z,eta12z,label="eta12 over z")
plt.plot(z,eta21z,label="eta21 ovar z")
plt.plot(z,eta22z,label="eta22 ovar z")
