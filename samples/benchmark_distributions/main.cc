/*
    Copyright (C) 2014-2020, Johannes Pekkila, Miikka Vaisala, Oskar Lappi
...
/*
 * Just a small modification of the benchmark program that prints out the entire distribution of results
 */
...
main(int argc, char** argv)
{
    ...
    fprintf(stdout,"Benchmarks ran, sorting and printing...\n\n");
    ...
    if (!pid) {
...

        {
            //Print all results
            char path[4096] = "";
            sprintf(path, "distribution_%s_%d.csv", test == TEST_STRONG_SCALING ? "strong" : "weak", nprocs);
