...
dryrun(void)
{
    ...
    {
	    acDeviceSetInput(acGridGetDevice(),AC_SUBSTEP,(SUBSTEP_NUMBER)substep);
...
main(int argc, char** argv)
{
    ...
    {
      acDeviceSetInput(acGridGetDevice(), AC_SUBSTEP, (SUBSTEP_NUMBER) 0);
      acGridExecuteTaskGraph(acGetOptimizedDSLTaskGraph(AC_calc_timestep),1);
#ifdef PENCIL_A
      acGridSynchronizeStream(STREAM_ALL);
