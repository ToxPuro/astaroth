...
if 'aver' in sys.argv:
    ...
    for i in mesh_file_numbers:
        ...
        if mesh.ok:
            ...
            print("mesh.lnrho  MAX",np.amax(mesh.lnrho),"MIN", np.amin(mesh.lnrho),"RMS",np.sqrt(np.mean((mesh.lnrho)**2.0)))
            print("uu_tot      MAX",np.amax(uu_tot    ),"MIN", np.amin(uu_tot    ),"RMS",np.sqrt(np.mean((uu_tot    )**2.0)))
            print("mesh.uu[0]  MAX",np.amax(mesh.uu[0]),"MIN", np.amin(mesh.uu[0]),"RMS",np.sqrt(np.mean((mesh.uu[0])**2.0)))
            print("mesh.uu[1]  MAX",np.amax(mesh.uu[1]),"MIN", np.amin(mesh.uu[1]),"RMS",np.sqrt(np.mean((mesh.uu[1])**2.0)))
            print("mesh.uu[2]  MAX",np.amax(mesh.uu[2]),"MIN", np.amin(mesh.uu[2]),"RMS",np.sqrt(np.mean((mesh.uu[2])**2.0)))
            print("aa_tot      MAX",np.amax(aa_tot    ),"MIN", np.amin(aa_tot    ),"RMS",np.sqrt(np.mean((aa_tot    )**2.0)))
            print("mesh.aa[0]  MAX",np.amax(mesh.aa[0]),"MIN", np.amin(mesh.aa[0]),"RMS",np.sqrt(np.mean((mesh.aa[0])**2.0)))
            print("mesh.aa[1]  MAX",np.amax(mesh.aa[1]),"MIN", np.amin(mesh.aa[1]),"RMS",np.sqrt(np.mean((mesh.aa[1])**2.0)))
            print("mesh.aa[2]  MAX",np.amax(mesh.aa[2]),"MIN", np.amin(mesh.aa[2]),"RMS",np.sqrt(np.mean((mesh.aa[2])**2.0)))
            print("bb_tot      MAX",np.amax(bb_tot    ),"MIN", np.amin(bb_tot    ),"RMS",np.sqrt(np.mean((bb_tot    )**2.0)))
            print("mesh.bb[0]  MAX",np.amax(mesh.bb[0]),"MIN", np.amin(mesh.bb[0]),"RMS",np.sqrt(np.mean((mesh.bb[0])**2.0)))
            print("mesh.bb[1]  MAX",np.amax(mesh.bb[1]),"MIN", np.amin(mesh.bb[1]),"RMS",np.sqrt(np.mean((mesh.bb[1])**2.0)))
            print("mesh.bb[2]  MAX",np.amax(mesh.bb[2]),"MIN", np.amin(mesh.bb[2]),"RMS",np.sqrt(np.mean((mesh.bb[2])**2.0)))
            print("mesh.shock  MAX",np.amax(mesh.shock),"MIN", np.amin(mesh.shock),"RMS",np.sqrt(np.mean((mesh.shock)**2.0)))
